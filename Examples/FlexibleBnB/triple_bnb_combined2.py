...
def main(poly_name='P1', show_plt=False):
    ...
    if bnb_alg.params.animation_logger:
        bnb_alg.params.animation_logger.save_log(f'triple_bnb_combined2/0.97/{poly_name}.gif')
    if bnb_alg.params.metric_logger:
        bnb_alg.params.metric_logger.save_log(f'triple_bnb_combined2/0.97/{poly_name}_log.png')
